...
class prestudent extends person
{
	...
	public function save_rolle()
	{
		if($this->new)
		{
			...
			//Andreas Koller: Falls orgform_kurzbz gleich NULL, dann soll der Wert "nd" (not defined) eingetragen werden
			//notwendig da es zur Fehlermeldung gekommen ist
			if ($this->orgform_kurzbz == NULL)
			{
				$this->orgform_kurzbz = "nd";
			}
