...
<office:document-content xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:rpt="http://openoffice.org/2005/report" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:grddl="http://www.w3.org/2003/g/data-view#" xmlns:tableooo="http://openoffice.org/2009/table" xmlns:field="urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0" xmlns:formx="urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:form:1.0" xmlns:css3t="http://www.w3.org/TR/css3-text/" office:version="1.2" grddl:transformation="http://docs.oasis-open.org/office/1.2/xslt/odf2rdf.xsl">
  ...
  <office:automatic-styles>
    ...
    <style:style style:name="T1" style:family="text">
      <style:text-properties style:font-name="TheSans" fo:font-size="6pt" style:font-size-asian="6pt" style:font-size-complex="6pt" fo:color="#777777"/>
    </style:style>
    <style:style style:name="T2" style:family="text">
      <style:text-properties style:font-name="TheSans" fo:font-size="9pt" style:font-size-asian="9pt" style:font-size-complex="9pt" fo:font-weight="bold"/>
    </style:style>
    <style:style style:name="T3" style:family="text">
      <style:text-properties style:font-name="TheSans" fo:font-size="9pt" style:font-size-asian="9pt" style:font-size-complex="9pt"/>
    </style:style>
...
<xsl:template match="student">
 ...
 <text:p text:style-name="P1">
		<draw:frame draw:style-name="fr1" draw:name="Grafik_{$uid}" text:anchor-type="char" svg:x="0.55cm" svg:y="1.30cm" svg:width="1.75cm" svg:height="2.38cm" draw:z-index="{$idx}5">
          <draw:image xlink:href="Pictures/{$uid}.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/>
        </draw:frame>
...
<!-- <>
		<draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}0" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.733cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="2.25cm">
          <draw:text-box>
		    ...
		    <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}0" draw:style-name="gr1" draw:text-style-name="P7" svg:width="2cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="1.3cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T2">STUDENT</text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>

		    <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}1" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.733cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="1.90cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T1">Vorname Nachname / Name surname</text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>
        
        <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}2" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.827cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="2.25cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T3"><xsl:value-of select="vorname"/>&#160;<xsl:value-of select="nachname"/></text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>

        <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}3" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.806cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="2.70cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T1">Geburtsdatum / Date of birth</text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>
...
<!-- <>
        ...
        <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}4" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.765cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="3.05cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T3"><xsl:value-of select="gebdatum"/></text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>
        
<!-- <>
        <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}5" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.806cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="3.50cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T1">Studiengang / Course of studies</text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>

        <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}6" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.79cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="3.85cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T3"><xsl:value-of select="studiengang"/></text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>
</> -->
        <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}5" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.806cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="3.50cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T1">Ausstellungsdatum / Date of issue</text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>
        ...
        <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}6" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.79cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="3.85cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T3"><xsl:value-of select="ausstellungsdatum"/></text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>

		<draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}7" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.79cm" svg:height="0.3cm" svg:x="0.55cm" svg:y="3.85cm">
          <draw:text-box>
            <text:p text:style-name="P7">
              <text:span text:style-name="T2"><xsl:value-of select="matrikelnummer"/></text:span>
            </text:p>
          </draw:text-box>
        </draw:frame>
      </text:p>
