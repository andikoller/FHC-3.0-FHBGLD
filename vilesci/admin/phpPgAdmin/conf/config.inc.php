<?php
	...
	$conf['servers'][0]['desc'] = 'CALVA';

	// Hostname or IP address for server.  Use '' for UNIX domain socket.
	// use 'localhost' for TCP/IP connection on this computer
	$conf['servers'][0]['host'] = 'calva.technikum-wien.at';	//
	...
	// Antigone
	$conf['servers'][1]['desc'] = 'ANTIGONE';
	$conf['servers'][1]['host'] = 'antigone.technikum-wien.at';
	...
	// hydra
	$conf['servers'][2]['desc'] = 'HYDRA';
	$conf['servers'][2]['host'] = 'hydra.technikum-wien.at';
	...
	$conf['servers'][2]['slony_sql'] = '/usr/share/pgsql';
	
	// localhost
	$conf['servers'][3]['desc'] = 'Localhost';
	...
	$conf['servers'][3]['slony_support'] = false;
	$conf['servers'][3]['slony_sql'] = '/usr/share/pgsql';
	
	// localhost
	$conf['servers'][3]['desc'] = 'theseus';
	$conf['servers'][3]['host'] = 'theseus.technikum-wien.at';
	$conf['servers'][3]['port'] = 5432;
	$conf['servers'][3]['sslmode'] = 'allow';
	$conf['servers'][3]['defaultdb'] = 'template1';
	$conf['servers'][3]['pg_dump_path'] = '/usr/bin/pg_dump';
