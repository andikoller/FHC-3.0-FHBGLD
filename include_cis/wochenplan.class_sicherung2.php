...
class wochenplan extends basis_db
{
	...
	public function draw_header()
	{
		...
		echo '			<tr><td  style="padding:3px 15px 0px 15px; margin: 0,0,20px,0;" align="center" colspan="2">'.$this->crlf;
		...
		//vom: 28.07.2010 bis: 29.07.2030
		$kal_link_alle=$this->kal_link.'&begin=1280323589&ende=1911548612';
		$kal_link_aktuell=$this->kal_link.'&begin='.$this->studiensemester_now->start.'&ende='.$this->studiensemester_now->ende;
		...
		//Andreas Koller: Die folgende Zeile ersetzt die darauf folgende -> Anstatt des Semesternamens wird nun nur noch das Wort "Kalenderexport" angegeben
		//echo				$this->studiensemester_now->name.'<br>'.$this->crlf;
		echo '				<b>Kalender-Export</b></td></tr>'.$this->crlf;
		echo '				<tr><td align=center width=50%>Alle Semester</td><td align=center width=50%> Aktuelles Semester</td></tr>'.$this->crlf;
		//ALLE SEMESTER CSV
		echo '				<tr><td align=center><A href="'.$kal_link_alle.'&format=csv" title="Alle Semester - CSV"><IMG src="../../../skin/images/csv.png" height="30" alt="Alle Semester - CSV" border="0"></A>'.$this->crlf;
		...
		//ALLE SEMESTER ICAL 2:
		echo '				<A href="'.$kal_link_alle.'&format=ical&version=1&target=ical" title="Alle Semester - iCal Version 2.0"><IMG src="../../../skin/images/ical2.0.png" height="30" alt="vCal Version 2.0" border="0"></A></td>'.$this->crlf;
		//AKTUELLES SEMESTER ICAL 2:
		echo '				<td align=center><A href="'.$kal_link_aktuell.'&format=ical&version=2&target=ical" title="Aktuelles Semester - iCal Version 2.0"><IMG src="../../../skin/images/ical2.0.png" height="30" alt="vCal Version 2.0" border="0"></A>'.$this->crlf;
		//AKTUELLES SEMESTER HTML:
		echo '				<A href="'.$kal_link_aktuell.'&format=html" target="_blank" title="HTML"><IMG src="../../../skin/images/html.png" height="30" alt="HTML" border="0"></A>'.$this->crlf;
		echo '				</td>';
		//echo '				<td class="stdplan" style="padding:8px;" align="center">'.$p->t('lvplan/semesterplaene').'</td>';
		//echo '				<td style="padding:3px 15px 0px 15px;" align="center">';
		...
		//Andreas Koller: Das kommende Semester wurde auskommentiert:
